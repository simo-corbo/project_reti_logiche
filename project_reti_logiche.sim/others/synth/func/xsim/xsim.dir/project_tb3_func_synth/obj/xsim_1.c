...
{
	iki_relocate(dp, "xsim.dir/project_tb3_func_synth/xsim.reloc",  (void **)funcTab, 104);
	iki_vhdl_file_variable_register(dp + 1194080);
	iki_vhdl_file_variable_register(dp + 1194136);
