...
{
	iki_relocate(dp, "xsim.dir/project_tb5_func_synth/xsim.reloc",  (void **)funcTab, 104);
	iki_vhdl_file_variable_register(dp + 1194200);
	iki_vhdl_file_variable_register(dp + 1194256);
