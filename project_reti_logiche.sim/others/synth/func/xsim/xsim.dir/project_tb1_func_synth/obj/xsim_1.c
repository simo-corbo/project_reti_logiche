...
{
	iki_relocate(dp, "xsim.dir/project_tb1_func_synth/xsim.reloc",  (void **)funcTab, 104);
	iki_vhdl_file_variable_register(dp + 1193600);
	iki_vhdl_file_variable_register(dp + 1193656);
