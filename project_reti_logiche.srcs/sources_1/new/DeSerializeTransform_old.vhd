...
begin
    ...
    mode_change: process(i_clk, reset)                                                 --lambda and delta function
    begin
        if(i_clk'event and i_clk='1') then 
        input_s<=input;
                                             --DeSerT synchronized on clock's raising edge
            ...
            case mode is
                ...
                when GET_CH0 =>                                                 --GET_CH0 saves the LSB of Channel  
                    ...
                    internal_out_address<=(others=>'0');
                    if(start='1') then
                        internal_out_address(0)<=input_s;
